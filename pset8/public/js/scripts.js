...
$(function() {
    ...
    var options = {
        center: {lat: 47.620499, lng: -122.350876}, // Seattle
...
function configure()
{
    ...
    },
    {
        ...
        templates: {
            ...
            suggestion: _.template('<p><%- place_name %>, <%- admin_name1 %>, <span style="opacity:.5;"><%- postal_code %></span></p>')
        }
    });
